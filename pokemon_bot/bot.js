...
bot.on('ready', function () { return console.log('heyyy'); });
var pokemonApiAdress = 'https://pokeapi.co/api/v2/pokemon/';
bot.on('message', function (message) { return __awaiter(void 0, void 0, void 0, function () {
    var messageText, pokemonName, data, pokemonImageUrl, ex_1;
        ...
        switch (_a.label) {
            case 0:
                ...
                if (!messageText.startsWith('!'))
                    return [2 /*return*/];
                pokemonName = messageText.slice(1);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, axios_1["default"].get("" + pokemonApiAdress + pokemonName)];
            case 2:
                data = (_a.sent()).data;
